...
export default function CTA() {
  return (
    <section id="join" className="section" style={{
      ...
      <div aria-hidden className="serif" style={{
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <Reveal>
          <h2 className="serif" style={{
            ...
            Vaš transfer,<br />
            <em style={{ color: 'var(--crimson-bright)' }}>već</em> rezervisan.
          </h2>
        </Reveal>

        <Reveal delay={0.1}>
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', maxWidth: 360, margin: '0 auto 52px', lineHeight: 1.8 }}>
